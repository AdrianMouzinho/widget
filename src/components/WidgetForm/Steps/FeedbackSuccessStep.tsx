...
export function FeedbackSuccessStep({ onFeedbackRestartRequested }: FeedbackSuccessStepProps) {
    return (
        <>
            <header className="relative inline w-full bg-zinc-900">
                <CloseButton />
            </header>

            <div className="flex flex-col items-center justify-center my-10 min-w-[304px] w-full">
                ...
                <span className="mt-2 mb-6 text-zinc-100 text-xl leading-6">
                ...
                <button 
                    ...
                    className="px-6 py-2 text-zinc-100 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
                >
                    Quero enviar outro
                </button>
            </div>
